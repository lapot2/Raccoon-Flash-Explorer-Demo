...
//		ptr1 = text(ptr1, "\r\n---Debug---", 0);
//		//
//		cset_fwd = bit_seek_read(0, 0xfe00);
//		cset_rev = bit_seek_read(1, 0xffff);
//		ptr1 = text(ptr1, "\r\nbit-seek test: \r\nMANU/Forward: ", 0);
//		ptr1 = hex2str(ptr1, &cset_fwd, 1);
//		
//		ptr1 = text(ptr1, "\r\nV3.3/Reverse: ", 0);
//		ptr1 = hex2str(ptr1, &cset_rev, 1);
		//
//		ptr1 = text(ptr1, "\r\n\r\nP0M0: ", 0); i = P0M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P0M1: ", 0); i = P0M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP1M0: ", 0); i = P1M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P1M1: ", 0); i = P1M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP2M0: ", 0); i = P2M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P2M1: ", 0); i = P2M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP3M0: ", 0); i = P3M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P3M1: ", 0); i = P3M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP4M0: ", 0); i = P4M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P4M1: ", 0); i = P4M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP5M0: ", 0); i = P5M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P5M1: ", 0); i = P5M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP6M0: ", 0); i = P6M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P6M1: ", 0); i = P6M1;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, "\r\nP7M0: ", 0); i = P7M0;
//		ptr1 = hex2str(ptr1, &i, 1);
//		ptr1 = text(ptr1, " P7M1: ", 0); i = P7M1;
//		ptr1 = hex2str(ptr1, &i, 1);
		//
//		ptr1 = text(ptr1, "\r\n\r\nRDID: ", 0);
//		ptr1 = hex2str(ptr1, spi_JDID_id-5, 1);

//		ptr1 = text(ptr1, "\r\nREMS: ", 0);
//		ptr1 = hex2str(ptr1, spi_JDID_id-4, 4);
//		
//		ptr1 = text(ptr1, "\r\nJDID: ", 0);
//		ptr1 = hex2str(ptr1, spi_JDID_id-0, 3);
//		
//		ptr1 = text(ptr1, "\r\nUUID: ", 0);
//		ptr1 = hex2str(ptr1, spi_JDID_id+3, 8);
//		//
//		if(verify_enabled) ptr1 = text(ptr1, "\r\n\r\nVerification Enabled", 0);
//		else ptr1 = text(ptr1, "\r\n\r\nVerification Disabled", 0);
//		
//		if(vcc_sfdp) ptr1 = text(ptr1, "\r\n\r\nVCC FROM SFDP", 0);
//		else if(reg_wr_flag) ptr1 = text(ptr1, "\r\n\r\nVCC FROM TEST", 0);
//		else ptr1 = text(ptr1, "\r\n\r\nVCC FROM PING", 0);
		
		//sound test
//		ptr1 = text(ptr1, "\r\nSound Freq: ", 0);
//		ptr1 = uint2str(ptr1, freq);
		
		
		// xram dump to spi
//		memset_xram(scsibuf, 0xa5, 4096);
//		P70 = 0;
//		while (usb_bulk_intr_in_busy());
//		usb_write_fifo((BYTE)(FIFO0 + 1), scsibuf, 64);
//		P70 = 1;
//			//XRAM DUMP
//			//
//			DPTR1 = 0;
//		do{
//			spi_cmd(SPI_PAGEPROG, DPTR1);
//			//
//			#pragma asm
//				PUSH DPS
//			MOV DPS, #019H
