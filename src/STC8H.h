...
#define BREG0 (*(unsigned char volatile data *)0x00)
#define BREG1 (*(unsigned char volatile data *)0x01)
#define BREG2 (*(unsigned char volatile data *)0x02)
#define BREG3 (*(unsigned char volatile data *)0x03)
#define BREG4 (*(unsigned char volatile data *)0x04)
#define BREG5 (*(unsigned char volatile data *)0x05)
#define BREG6 (*(unsigned char volatile data *)0x06)
#define BREG7 (*(unsigned char volatile data *)0x07)
	
#define WREG0 (*(unsigned int volatile data *)0x00)
#define WREG1 (*(unsigned int volatile data *)0x02)
#define WREG2 (*(unsigned int volatile data *)0x04)
#define WREG3 (*(unsigned int volatile data *)0x06)
	
#define DREG0 (*(unsigned long volatile data *)0x00)
#define DREG1 (*(unsigned long volatile data *)0x04)
