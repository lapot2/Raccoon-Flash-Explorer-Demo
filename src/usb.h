...
#define     INTRUSBE                (USBBASE + 11) // INTRUSBE
#define     SOFIE                   0x08
#define     RSTIE                   0x04
#define     RSUIE                   0x02
#define     SUSIE                   0x01
#define     FRAME1                  (USBBASE + 12) // FRAME1
#define     FRAME2                  (USBBASE + 13) // FRAME2
#define     INDEX                   (USBBASE + 14) // INDEX
#define     INMAXP                  (USBBASE + 16) // INMAXP
#define     CSR0                    (USBBASE + 17) // CSR0
#define     SSUEND                  0x80
#define     SOPRDY                  0x40
#define     SDSTL                   0x20
#define     SUEND                   0x10
...
#define     IPRDY                   0x02
#define     OPRDY                   0x01
#define     INCSR1                  (USBBASE + 17) // INCSR1
#define     INCLRDT                 0x40
#define     INSTSTL                 0x20
#define     INSDSTL                 0x10
#define     INFLUSH                 0x08
...
#define     INIPRDY                 0x01
#define     INCSR2                  (USBBASE + 18) // INCSR2
...
#define     INENDMA                 0x10
#define     INFCDT                  0x08
#define     OUTMAXP                 (USBBASE + 19) // OUTMAXP
#define     OUTCSR1                 (USBBASE + 20) // OUTCSR1
...
#define     OUTCSR2                 (USBBASE + 21) // OUTCSR2
#define     OUTAUTOCLR              0x80
#define     OUTISO                  0x40
#define     OUTENDMA                0x20
#define     OUTDMAMD                0x10
#define     COUNT0                  (USBBASE + 22) // COUNT0
#define     OUTCOUNT1               (USBBASE + 22) // OUTCOUNT1
#define     OUTCOUNT2               (USBBASE + 23) // OUTCOUNT2
