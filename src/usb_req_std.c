...
static BYTE xdata serial_number[14];
...
void usb_get_descriptor()
{
    ...
    case DESC_STRING:
        ...
        case 2:
            ...
            break;
        case 3:
					// MCU S/N copying from CHIPID0-7. ASCII to Unicode convert
						hex2str(serial_number, &CHIPID0, 7);
						//
						for(i = 0, y = 0; 14 > i; i++, y +=2)
						{
							memcpy(SERIALDESC+2+y, serial_number+i, 1);
						}
						// S/N copying done
